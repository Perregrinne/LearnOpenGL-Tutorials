...
#include <glad/glad.h> //For the openGL headers
...
public:
    ...
    //Constructor builds the shader and takes in the paths for the
    //vertex shader source code and the fragment path source code.
    Shader(const char* vertexPath, const char* fragmentPath)
    {
        //Step 1: Read in the vertex or fragment shader source from the given paths
        std::string vertexCode;
        std::string fragmentCode;
        std::ifstream vShaderFile;
        std::ifstream fShaderFile;
        //The ifstreams can throw exceptions
        ...
        try
        {
            ...
            //Read the file's buffer content into the streams
            vShaderStream << vShaderFile.rdbuf();
            fShaderStream << fShaderFile.rdbuf();
            //And close the handlers
            vShaderFile.close();
            fShaderFile.close();
    ...
    //For using or activating the shader:
